...
- **E-mails transactionnels + taux EUR réel (2026-07-19)** : confirmation de commande (webhook), expédition (nouveau flux dashboard « Marquer expédiée » + n° de suivi) et remboursement — envois jamais bloquants, mode test Resend. Taux CHF→EUR vivant (Frankfurter, repli 1.06) figé sur chaque commande EUR (`taux_eur`).
