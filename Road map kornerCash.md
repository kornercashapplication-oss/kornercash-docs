...
- [ ] **Créer 5 bannières utilisables sur le site** (ajouté 2026-07-20) — aujourd'hui le hero de l'accueil affiche **une seule** image (`/banniere-ete-upscale.jpg`, plafonnée à 60vh sur ordi). À trancher : stock de 5 bannières à échanger à la main (saisons / opérations, zéro code) **ou** rotation/carrousel à coder dans `app/page.tsx`. Contraintes : très large (l'actuelle fait 6832×2496), lisible en mobile, DA bleu `#3a5a99` + Montserrat.
