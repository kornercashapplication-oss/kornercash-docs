...
- **Expédition d'une commande en ligne** (2026-07-19) : bouton « Marquer expédiée » + n° de suivi optionnel (`numero_suivi`) + e-mail client
...
- [x] Tester le parcours d'achat **jusqu'au paiement** (recherche → panier → paiement Stripe : 8/8 en local, 2026-07-09) — *e-mails transactionnels développés le 19-07 — reste la re-vérification en prod (paiement + les 3 e-mails)*
